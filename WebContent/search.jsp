...
<body>
    ...
    <section>
        ...
        <%
        	ArrayList<SurveyDto> dto = (ArrayList)session.getAttribute("search");
            
            if(dto.size() != 0){
        %>
	        <div class="sresult">
	        	<h2>검색하신 "<%=(String) session.getAttribute("scontent")%>" 에 대한 검색결과입니다.</h2>
	        </div>
        <%	}
            else{    
        %>
	       	<div class="sresult">
	        	<h2>검색하신 "<%=(String) session.getAttribute("scontent")%>" 에 대한 검색결과가 없습니다.</h2>
	        </div>
        <%} %>
        <form action="#">
            	...
            	<% 
	             ...
	             %>
			                <div class="survey">
			                    ...
			                    <div class="ti" style="color:gray;">
			                        <%= dto.get(i).getTitle() %>
			                    </div>
			                    <div class="con">
			                        <%= dto.get(i).getStitle() %>
			                    </div>
			                    <button type="submit" class="sb" style="background-color:gray;" disabled>설문조사 참여</button>
			                    <div class="dp">
