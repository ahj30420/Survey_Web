...
<body>
    ...
    <main>
    <%
    	ArrayList<AnqpdetDto> dto = (ArrayList)session.getAttribute("ad_an_qp_det");
    	int qind = (int)session.getAttribute("aqdqind");
    	String question = (String)session.getAttribute("aqdquestion");
    %>
        <div class="title">no.<%=qind%>: <%=question%> | 퀵폴 참여 결과</div>
        <div class="tb">
            <table>
                <thead>
                    <tr>
                ...
                %>
                    <tr>
                        <td><%=i+1 %></td>
                        <td><%=dto.get(i).getConselect() %></td>
                        <td><%=dto.get(i).getCount() %></td>
                    </tr>
                <%
                	}
                %>
