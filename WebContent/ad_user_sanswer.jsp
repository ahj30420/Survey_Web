...
<body>
    ...
    <main>
    	<%
    		...
    		ArrayList<SparticipationDto> spdto = (ArrayList)session.getAttribute("user_participation"); 
    		ArrayList<SquestionDto> sqdto = (ArrayList)session.getAttribute("user_question");
    	%>
        <div class="title"><%=user_name%>의 답변</div>
        <div class="tb">
            <table>
                <thead>
                    <tr>
                ...
                %>
                    <tr>
                        <td><%=spdto.get(i).getNumques()%></td>
                        <td><%=sqdto.get(i).getQuestion()%></td>
                        <td class="text-left"><span><%=spdto.get(i).getNumselect()%></span> : <%=sqdto.get(i).getConselect()%></td>
                    </tr>
                <%
               		}
                %>
