            	...
            	<% 
	             ...
	             %>
			                <div class="survey">
			                    ...
			                    <button type="submit" class="sb" style="background-color:gray;" disabled>설문조사 마감</button>
			                    <div class="dp">
		                  ...
		                  %>				
			                  <div class="survey">
			                    ...
			                    <button type="submit" class="sb" name="ti" value="<%= dto.get(i).getTitle()%>">설문조사 참여</button>
			                    <div class="dp">
			                        <span><%= dto.get(i).getDeadline() %></span><span>+<%= dto.get(i).getPoint() %>P</span>
			                    </div>
	              			  </div>	
