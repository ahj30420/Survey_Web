...
<body>
    ...
    <main>
    	<%
    		...
    		ArrayList<SurveyDto> sdto = (ArrayList)session.getAttribute("ad_user_survey");
    		ArrayList<Date> pdate = (ArrayList)session.getAttribute("ad_user_survey_date");
    	%>
        <div class="title"><%=user_name%>님의 포인트(<%=point%> P)</div>
        <div class="tb">
            <table>
                <thead>
                    <tr>
                ...
                %>
                    <tr>
                        ...
                        <td><a href="ad_user_sanswer.do?sind=<%=sdto.get(i).getInd()%>"><%=sdto.get(i).getTitle() %></a></td>
