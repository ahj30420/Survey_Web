...
<body>
    ...
    <main>
    <%
    	ArrayList<AnqpDto> dto = (ArrayList)session.getAttribute("ad_an_qp");
    %>
        <div class="title">퀵폴 분석(<%=dto.size()%>)</div>
        <div class="tb">
            <table>
                <thead>
                    <tr>
                ...
                %>
                    <tr>
                        ...
                        <td><a href="ad_an_qp_det.do?qind=<%=dto.get(i).getQind()%>&&question=<%=dto.get(i).getQuestion()%>"><%=dto.get(i).getQuestion()%></a></td>
                        <td><a href="ad_an_qp_num.do?qind=<%=dto.get(i).getQind()%>&&question=<%=dto.get(i).getQuestion()%>"><%=dto.get(i).getCount()%></a></td>
                    </tr>
                <%
                	}
                %>   
