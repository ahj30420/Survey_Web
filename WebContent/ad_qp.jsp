...
<body>
    ...
    <div class="menu_bar">
        ...
        <div class="content">
            ...
            <div class="sub"><a href="ad_qp.do" style="color:red;">퀵폴 (quickpoll)</a></div>
        </div>
        <div class="content">
            <div>설문조사 분석</div>
    ...
    <main>
    	<%
    		ArrayList<QpDto> dto = (ArrayList)session.getAttribute("ad_qp");
    		ArrayList<String> ad_qp_mid = (ArrayList)session.getAttribute("ad_qp_mid");
    	%>
        <div class="title">
             전체 퀵폴(<%=dto.size()%>)
        </div>
        <div class="tb">
            <table>
                ...
                %>
                    <tr>
                        <td><%=dto.get(i).getQind()%></td>
                        <td><div class="img" style="background-image: url(<%=dto.get(i).getImage()%>)"></div></td>
                        <td><%=dto.get(i).getQuestion()%></td>
                        <td><%=ad_qp_mid.get(i)%></td>
                        <td><%=dto.get(i).getRedate()%></td>
                        <td><%=dto.get(i).getDeadline()%></td>
                        <form action="ad_qpdelete.do">
                        	<td><button type="submit" class="qpdelete" name="qpdelete" value="<%=dto.get(i).getQind()%>">삭제</button></td>
                        </form>
                    </tr>
                <%
                	}
