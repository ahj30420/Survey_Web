...
<body>
    ...
    <div class="menu_bar">
        ...
        <div class="content">
            ...
            <div class="sub"><a href="ad_ad.do" style="color:red;">관리자</a></div>
    ...
    <main>
    	<%
    		ArrayList<MemberDto> admdto = (ArrayList)session.getAttribute("admininfo");
    	%>
        <div class="title">전체 멤버(<%=admdto.size()%>)</div>
        <div class="tb">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                	<%
                		for(int i = 0; i < admdto.size(); i++){
                	%>
                    <tr>
                        <td><%=admdto.get(i).getInd()%></td>
                        <td><%=admdto.get(i).getName()%> <%=admdto.get(i).getId()%></td>
                        <td><%=admdto.get(i).getRedate()%></td>
                        <td><%=admdto.get(i).getEmail()%></td>
                    </tr>
                    <%
                    	}
                    %>
