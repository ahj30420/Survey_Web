...
<body>
    ...
    <main>
    	<%
    		ArrayList<Ansurveynum> asn = (ArrayList)session.getAttribute("asn");
    		int sind = (int)session.getAttribute("asnsind");
    		String title = (String)session.getAttribute("asntitle");
    	%>
        <div class="title">no.<%=sind%> : <%=title%> | 설문 참여 현황</div>
        <div class="tb">
            <table>
                <thead>
                    <tr>
                ...
                %>
                    <tr>
                        <td><%=asn.get(i).getMind()%></td>
                        <td><%=asn.get(i).getId()%></td>
                        <td><%=asn.get(i).getPdate()%></td>
                    </tr>
             	<%
                		}
                	}
